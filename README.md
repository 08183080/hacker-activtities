...
- [ ] 【绍兴 东山之行】放在清明节之后吧
- [ ] 【义乌之行】
- [x] 【当 AI 遇到屏幕】MSReactor 活动
  - [x] 一想都是问题，一座都是答案。
  - [x] 我们倾向于高估于短期的成就，低估长期的成就
  - [x] 千万不要沉迷AI 的幻想，先用它去做我们不擅长的工作，让 AI 代替，再去决定我们想干什么
  - [x] 我们必须要去想那些既难又简单的事情
  - [x] 问题导向，看到要做什么，再去看看工具箱
  - [x] 机器再牛，都是以数据为基石
  - [x] 人工智能是学习是模式识别，是自动化，你要有自己的工具箱，不要有自己的信息jian房
  - [x] AI Agent，不断的抽象，不断的理解，序列化归化和执行
  - [x] 年轻人和时代同步的人不会收到冲击
  - [x] 什么叫智能？
  - [x] 观众问题，一句话证明你们自己不是数字人？
# online
